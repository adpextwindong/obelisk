...
import Obelisk.Math.Homogenous (m22AffineIdD)
...
-- Not sure how this will work with the Tagged types.

-- pdToWorldPos :: M22Affine Float -> SDL.Point V2 Float -> V2 Float
-- pdToWorldPos t' (SDL.P pos) = dropHomoCoords . (pdToWorldT t !*) . homoCoords $ position
